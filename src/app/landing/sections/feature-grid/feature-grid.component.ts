          ...
          @for (card of cards; track card.title; let i = $index) {
            ...
            >
              ...
              <div class="relative mt-auto">
                ...
                <p class="mt-1.5 text-sm leading-relaxed text-gray-500">{{ card.description }}</p>
              </div>
            </div>
          }
        </div>
...
export class FeatureGridComponent {
  ...
  readonly cards: BentoCard[] = [
    ...
    {
      title: 'History',
      description: 'Every scan archived chronologically.',
      span: 'col-span-1 md:col-span-2 lg:col-span-2',
      glow: 'rgba(79,209,197,0.2)',
      icon: this.icon('<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2"/>'),
    },
    {
      title: 'Progress Tracking',
      description: 'Watch lesions over weeks and months.',
      span: 'col-span-1 md:col-span-2 lg:col-span-2',
    ...
    },
    {
      ...
      icon: this.icon('<path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z"/>'),
    },
    {
      ...
      icon: this.icon('<rect x="2" y="5" width="13" height="11" rx="1.5"/><rect x="16" y="8" width="6" height="11" rx="1.5"/>'),
    },
  ];
}
