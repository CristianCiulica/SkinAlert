        ...
        <div class="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <h2 id="tech-heading" appReveal mode="words" [stagger]="0.05" class="mt-6 max-w-2xl text-4xl font-semibold tracking-tight text-paper sm:text-5xl">
              Inteligență la standarde clinice.
            </h2>
          </div>
            ...
            >
              <div class="flex items-start justify-between">
                <span
                  ...
                  aria-hidden="true"
                ></span>
                <span class="text-xs font-semibold tabular-nums text-paper/30">{{ card.index }}</span>
              </div>
...
export class TechnologyComponent {
  ...
  readonly facts: ModelFact[] = [
    ...
    { value: 'AUC 0.921', label: 'Pe poze de tip telefon — mai greu decât dermatoscopia (AUC 0.993), și o spunem deschis' },
  ];
